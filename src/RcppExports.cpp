...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(stratEst_cpp(data, strategies, shares, covariates, LCR, cluster, response, r_responses, r_trembles, select, min_strategies, crit, SE, outer_runs, outer_tol_eval, outer_max_eval, inner_runs, inner_tol_eval, inner_max_eval, LCR_runs, LCR_tol_eval, LCR_max_eval, BS_samples, print_messages));
    return rcpp_result_gen;
END_RCPP
}
// transform_cpp
