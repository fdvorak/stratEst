...
stratEst_cpp <- function(data, strategies, shares, covariates, LCR, cluster, response = "mixed", r_responses = "no", r_trembles = "global", select = "no", min_strategies = 1L, crit = "bic", SE = "yes", outer_runs = 10L, outer_tol_eval = 0, outer_max_eval = 1000L, inner_runs = 100L, inner_tol_eval = 0, inner_max_eval = 100L, LCR_runs = 100L, LCR_tol_eval = 0L, LCR_max_eval = 1000L, BS_samples = 1000L, print_messages = TRUE, integer_strategies = TRUE, newton_stepsize = 1, penalty = FALSE) {
