...
#'
#' @format A data frame with 13126 rows and 11 variables:
#' \describe{
...
#'   \item{last_choice}{A factor with two levels which indicates if the participant cooperated (c) or defected (d) in the previous period.}
#'   \item{last_other}{A factor with two levels which indicates if the other participant cooperated (c) or defected (d) in the previous period.}
